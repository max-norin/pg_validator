...
CREATE OR REPLACE FUNCTION "validation".url("value" ANYELEMENT) RETURNS BOOLEAN AS
$$
BEGIN
...
END
$$ LANGUAGE plpgsql;
CREATE OR REPLACE FUNCTION "validation".url_m("value" ANYELEMENT) RETURNS TEXT AS
$$
BEGIN
    RETURN "validation".url("value") OPERATOR ("validation".|) 'url'::text;
END
$$ LANGUAGE plpgsql;
